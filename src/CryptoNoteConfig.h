...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 0x150762;
...
const char     CRYPTONOTE_NAME[]                             = "Bitcoin Vibranium";
...
const std::initializer_list<const char*> SEED_NODES = {
  //"dnsseed.bluematt.me:8080",
  //"seed.btc.petertodd.org:8080",
};
